    ...
    <Row>
      <Col md="8">
        <h2 data-cy="formationDetailsHeading">
          <Translate contentKey="amcInscriptionApp.formation.detail.title">Formation</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>
            {formationEntity.ouvertureInscription ? (
              <TextFormat value={formationEntity.ouvertureInscription} type="date" format={APP_LOCAL_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
          ...
          <dd>
            {formationEntity.fermetureInscription ? (
              <TextFormat value={formationEntity.fermetureInscription} type="date" format={APP_LOCAL_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
