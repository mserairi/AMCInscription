...
export const FormationDeleteDialog = (props: IFormationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="amcInscriptionApp.formation.delete.question">
        <Translate contentKey="amcInscriptionApp.formation.delete.question" interpolate={{ id: formationEntity.id }}>
