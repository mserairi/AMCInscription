...
export const CategoryDeleteDialog = (props: ICategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="amcInscriptionApp.category.delete.question">
        <Translate contentKey="amcInscriptionApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
