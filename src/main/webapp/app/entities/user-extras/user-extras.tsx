  ...
  return (
    <div>
      <h2 id="user-extras-heading" data-cy="UserExtrasHeading">
        <Translate contentKey="amcInscriptionApp.userExtras.home.title">User Extras</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="amcInscriptionApp.userExtras.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="amcInscriptionApp.userExtras.home.createLabel">Create new User Extras</Translate>
          </Link>
        </div>
      </h2>
        ...
        {userExtrasList && userExtrasList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="amcInscriptionApp.userExtras.id">ID</Translate>
                </th>
                <th>
                ...
                <th>
                  <Translate contentKey="amcInscriptionApp.userExtras.user">User</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {userExtrasList.map((userExtras, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`amcInscriptionApp.TypeGenre.${userExtras.genre}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="amcInscriptionApp.userExtras.home.notFound">No User Extras found</Translate>
            </div>
          )
        )}
      </div>
