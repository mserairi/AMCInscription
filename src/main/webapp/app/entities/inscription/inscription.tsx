  ...
  return (
    <div>
      <h2 id="inscription-heading" data-cy="InscriptionHeading">
        <Translate contentKey="amcInscriptionApp.inscription.home.title">Inscriptions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="amcInscriptionApp.inscription.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="amcInscriptionApp.inscription.home.createLabel">Create new Inscription</Translate>
          </Link>
        </div>
      </h2>
        ...
        {inscriptionList && inscriptionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="amcInscriptionApp.inscription.id">ID</Translate>
                </th>
                <th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {inscription.dateinscription ? (
                      <TextFormat type="date" value={inscription.dateinscription} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    <Translate contentKey={`amcInscriptionApp.EtatInscription.${inscription.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="amcInscriptionApp.inscription.home.notFound">No Inscriptions found</Translate>
            </div>
          )
        )}
      </div>
