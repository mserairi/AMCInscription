        ...
        Optional<Formation> result = formationRepository
            ...
            .map(
                existingFormation -> {
                    ...
                    if (formation.getInstoLAT() != null) {
                        existingFormation.setInstoLAT(formation.getInstoLAT());
                    }
                    if (formation.getInsIsOpen() != null) {
                        existingFormation.setInsIsOpen(formation.getInsIsOpen());
                    }
                    if (formation.getInscriptionOuverte() != null) {
                        existingFormation.setInscriptionOuverte(formation.getInscriptionOuverte());
                    }
