  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="amcInscriptionApp.userExtras.home.createOrEditLabel" data-cy="UserExtrasCreateUpdateHeading">
            <Translate contentKey="amcInscriptionApp.userExtras.home.createOrEditLabel">Create or edit a UserExtras</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
