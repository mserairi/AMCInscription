...
export const UserExtrasDeleteDialog = (props: IUserExtrasDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="amcInscriptionApp.userExtras.delete.question">
        <Translate contentKey="amcInscriptionApp.userExtras.delete.question" interpolate={{ id: userExtrasEntity.id }}>
